  ...
  return (
    <div className="bg-white border-t border-neutral-200 p-4">
      <div className="flex items-end space-x-2">
        ...
        <div className="flex-1 bg-neutral-100 rounded-lg flex items-center overflow-hidden">
          <Textarea
            value={message}
            ...
            className="w-full bg-transparent border-0 focus-visible:ring-0 focus-visible:ring-offset-0 px-4 py-3 resize-none min-h-[44px] max-h-32"
            rows={1}
          />
        </div>
        <Button
