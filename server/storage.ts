      ...
      if (existingPersonas.length === 0 || existingAnimePersonas.length < animeNames.length) {
        ...
        const samplePersonas: InsertPersona[] = [
          ...
          },
          {
            ...
            avatarUrl: "https://i.imgur.com/AQPWDEK.jpg",
            isDefault: true,
            isPublic: true
          },
          {
            ...
            avatarUrl: "https://i.imgur.com/V4Sn6NJ.jpg",
            isDefault: true,
            isPublic: true
          },
          {
            ...
            avatarUrl: "https://i.imgur.com/AxzLXUJ.jpg",
            isDefault: true,
            isPublic: true
          },
          {
            ...
            avatarUrl: "https://i.imgur.com/KFXJwQI.jpg",
            isDefault: true,
            isPublic: true
          }
        ];
