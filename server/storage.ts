      ...
      if (existingPersonas.length === 0 || existingAnimePersonas.length < animeNames.length) {
        ...
        const samplePersonas: InsertPersona[] = [
          ...
          },
          {
            ...
            avatarUrl: "https://static.wikia.nocookie.net/naruto/images/d/d6/Naruto_Part_I.png",
            isDefault: true,
            isPublic: true
          },
          {
            ...
            avatarUrl: "https://static.wikia.nocookie.net/dragonball/images/5/5b/Goku_DBZ_Ep_122_002.png",
            isDefault: true,
            isPublic: true
          },
          {
            ...
            avatarUrl: "https://static.wikia.nocookie.net/solo-leveling/images/0/0e/SJW_Anime_Appearance.png",
            isDefault: true,
            isPublic: true
          },
          {
            ...
            avatarUrl: "https://static.wikia.nocookie.net/onepiece/images/6/6d/Monkey_D._Luffy_Anime_Post_Timeskip_Infobox.png",
            isDefault: true,
            isPublic: true
          }
        ];
